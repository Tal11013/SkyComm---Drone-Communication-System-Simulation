...
void print_telemetry(const std::vector<float>& telemetry) {
    std::cout << "Reconstructed telemetry data after demodulation:" << std::endl;
    std::cout << "-----------------------------------------------" << std::endl;
    if (telemetry.size() < 5) {
        std::cout << "Error: Telemetry data is incomplete." << std::endl;
        return;
    }

    std::cout << "  Speed: " << telemetry[0] << " m/s" << std::endl;
    std::cout << "  Direction: " << telemetry[1] << " degrees" << std::endl;
    std::cout << "  Latitude: " << telemetry[2] << std::endl;
    std::cout << "  Longitude: " << telemetry[3] << std::endl;
    std::cout << "  Altitude: " << telemetry[4] << " meters" << std::endl;
}
...
int main() {
    ...
    // Print telemetry data for verification
